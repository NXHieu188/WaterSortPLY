...
public static class HelperUtility
{
    ...
    public static void LookAtToDirectionAngleDetal(Vector3 diretion, GameObject objLookAt, float AngleDetal,
        float speedLockAt = 500)
    {
        float xTarget = diretion.x;
        float yTarget = diretion.y;
    ...
    public static void LookAtToPositionAngleDetal(Vector3 position, GameObject objLookAt, float AngleDetal,
        float speedRotate = 500)
    {
        float xTarget = position.x - objLookAt.transform.position.x;
    ...
    private const float OffsetTopColor = 70f / 255;
    private const float OffsetDoneColor = 110f / 255;
